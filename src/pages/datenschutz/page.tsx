        ...
        <section className="py-16">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            <div className="bg-white rounded-2xl shadow-card p-8 md:p-12 space-y-8">
              {/* Introduction */}
              <div>
                <h2 className="text-2xl font-heading font-bold text-primary mb-4">1. Datenschutz auf einen Blick</h2>
              ...
              {/* Data Collection */}
              <div>
                <h2 className="text-2xl font-heading font-bold text-primary mb-4">2. Datenerfassung auf dieser Website</h2>
                <div className="space-y-4 text-neutral-700">
                  <div>
                    <h3 className="font-semibold text-lg mb-2">Wer ist verantwortlich für die Datenerfassung auf dieser Website?</h3>
                  ...
                  <div>
                    <h3 className="font-semibold text-lg mb-2">Wofür nutzen wir Ihre Daten?</h3>
                    <p>Ein Teil der Daten wird erhoben, um eine fehlerfreie Bereitstellung der Website zu gewährleisten. Andere Daten können zur Analyse Ihres Nutzerverhaltens verwendet werden.</p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-lg mb-2">Welche Rechte haben Sie bezüglich Ihrer Daten?</h3>
              ...
              {/* Hosting */}
              <div>
                <h2 className="text-2xl font-heading font-bold text-primary mb-4">3. Hosting</h2>
                <div className="space-y-4 text-neutral-700">
                  <p>Wir hosten die Inhalte unserer Website bei folgendem Anbieter:</p>
                  <h3 className="font-semibold text-lg">Externes Hosting</h3>
              ...
              {/* General Information */}
              <div>
                <h2 className="text-2xl font-heading font-bold text-primary mb-4">4. Allgemeine Hinweise und Pflichtinformationen</h2>
                <div className="space-y-4 text-neutral-700">
                  <div>
                  ...
                  <div>
                    <h3 className="font-semibold text-lg mb-2">Beschwerderecht bei der zuständigen Aufsichtsbehörde</h3>
              ...
              <div>
                <h2 className="text-2xl font-heading font-bold text-primary mb-4">5. Datenerfassung auf dieser Website</h2>
                <div className="space-y-4 text-neutral-700">
                  <div>
                  ...
                  <div>
                    <h3 className="font-semibold text-lg mb-2">Anfrage per E-Mail, Telefon oder Telefax</h3>
              ...
              {/* SSL/TLS */}
              <div>
                <h2 className="text-2xl font-heading font-bold text-primary mb-4">6. SSL- bzw. TLS-Verschlüsselung</h2>
                <div className="space-y-4 text-neutral-700">
