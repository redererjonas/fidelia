          ...
          >
            ...
            >
              <div className="flex items-center justify-center gap-3 mb-8">
                ...
                <h2 className="text-2xl font-heading font-bold text-primary">Warum Anleihen?</h2>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                <div className="bg-gradient-to-br from-primary/5 to-primary/10 rounded-2xl p-6 border border-primary/20">
                  ...
                  <h3 className="font-bold text-primary mb-2 text-lg">Hohe Sicherheit</h3>
                  <p className="text-sm text-neutral-700">Staatsanleihen mit AAA-Rating für maximale Sicherheit</p>
                </div>
                <div className="bg-gradient-to-br from-amber-50 to-amber-100/50 rounded-2xl p-6 border border-amber-100">
                  ...
                  <h3 className="font-bold text-accent-gold700 mb-2 text-lg">Regelmäßige Zinsen</h3>
                  <p className="text-sm text-accent-gold700">Planbare Erträge durch feste Zinszahlungen</p>
                </div>
                <div className="bg-gradient-to-br from-green-50 to-green-100/50 rounded-2xl p-6 border border-green-100">
                  ...
                  <h3 className="font-bold text-green-700 mb-2 text-lg">Portfolio-Stabilität</h3>
                  <p className="text-sm text-green-700">Ausgleich von Aktienschwankungen</p>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-primary via-primary-dark to-slate-900 rounded-2xl p-8 text-white relative overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 w-48 h-48 bg-amber-400/20 rounded-full -ml-24 -mb-24"></div>
