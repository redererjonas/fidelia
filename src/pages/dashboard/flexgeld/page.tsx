      ...
      <div className="min-h-screen bg-gradient-to-br from-neutral-50 via-white to-neutral-100">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          >
            {/* Hero Icon */}
            <div className="mb-8">
              <div className="w-32 h-32 mx-auto bg-gradient-to-br from-primary via-slate-800 to-amber-600 rounded-3xl flex items-center justify-center shadow-2xl transform rotate-3 hover:rotate-0 transition-transform duration-500">
            ...
            >
              <div className="flex items-center justify-center gap-3 mb-8">
                ...
                <h2 className="text-2xl font-heading font-bold text-primary">Warum Flexgeld?</h2>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                <div className="bg-gradient-to-br from-amber-50 to-primary/5 rounded-2xl p-6 border border-amber-100">
                  ...
                  <h3 className="font-bold text-accent-gold700 mb-2 text-lg">Tägliche Verfügbarkeit</h3>
                  <p className="text-sm text-accent-gold700">Ihr Geld ist jederzeit verfügbar - ohne Kündigungsfrist</p>
                </div>
                <div className="bg-gradient-to-br from-amber-50 to-amber-100/50 rounded-2xl p-6 border border-amber-100">
                  ...
                  <h3 className="font-bold text-primary mb-2 text-lg">Attraktive Zinsen</h3>
                  <p className="text-sm text-primary">Bis zu 2,8% p.a. auf Ihre Einlagen</p>
                </div>
                <div className="bg-gradient-to-br from-green-50 to-green-100/50 rounded-2xl p-6 border border-green-100">
                  ...
                  <h3 className="font-bold text-green-700 mb-2 text-lg">Maximale Sicherheit</h3>
                  <p className="text-sm text-green-700">Einlagensicherung bis 100.000 € pro Kunde</p>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-primary via-primary-dark to-slate-900 rounded-2xl p-8 text-white relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-white/90 mb-6 text-lg">
                    Kontaktieren Sie uns für eine persönliche Beratung. Wir helfen Ihnen gerne, die beste Anlagestrategie für Ihre Bedürfnisse zu finden.
                  </p>
